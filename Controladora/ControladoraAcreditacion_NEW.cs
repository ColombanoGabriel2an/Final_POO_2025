          ...
          if (!context.Acreditaciones.Any())
          {
            ...
            if (tarjetas.Any())
            {
              var acreditaciones = new List<Acreditacion>
                            {
                                new Acreditacion(tarjetas[0], new DateTime(2025, 01, 10), "09:00", "Transferencia bancaria", 5000, "ARG"),
                                new Acreditacion(tarjetas[0], new DateTime(2025, 01, 20), "10:30", "Depósito efectivo", 2000, "ARG")
                            };

              if (tarjetas.Count > 1)
              {
                acreditaciones.Add(new Acreditacion(tarjetas[1], new DateTime(2025, 01, 15), "11:00", "Transferencia online", 3000, "ARG"));
              }
